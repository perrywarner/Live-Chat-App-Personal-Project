...
// local
import { HomeOption, MessageOption, SettingsOption, UserOption } from './Options';
import './Sidenav.css';
    ...
    return (
        <nav className='sidenav'>
            <div className='sidenav-icons'>
                <HomeOption isSelected={selectedIcon === 'Home'} onClick={() => handleClick('Home')}/>
                <div className='sidenav-icons-selectpage'>
                    <MessageOption isSelected={selectedIcon === 'Home'} onClick={() => handleClick('Message')}/>
                    <SettingsOption isSelected={selectedIcon === 'Home'} onClick={() => handleClick('Settings')}/>
                </div>
